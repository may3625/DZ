...
export function NomenclatureSection({ language = "fr" }: NomenclatureSectionProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Modales d'ajout via système unifié */}
      {isLegalTypeModalOpen && (
        <UnifiedModalSystem
          modal={{
            id: 'legal-type-management',
            type: 'form',
            title: 'Type de texte juridique',
            onSave: async () => {},
            onCancel: () => setIsLegalTypeModalOpen(false)
          }}
      ...
      {isCategoryModalOpen && (
        <UnifiedModalSystem
          modal={{
            id: 'procedure-category-management',
            type: 'form',
            title: 'Catégorie de procédure',
            onSave: async () => {},
      ...
      {isSignatoryModalOpen && (
        <UnifiedModalSystem
          modal={{
            ...
            onSave: async () => {},
            onCancel: () => setIsSignatoryModalOpen(false)
          }}
