  ...
  return (
    <Card>
      <CardHeader className="border-b border-green-100 bg-green-50">
        ...
        <CardDescription>
          Extraction complètement hors ligne avec PDF.js, Tesseract.js et analyse NLP locale - Aucune donnée transmise sur Internet
        </CardDescription>
      </CardHeader>
      <CardContent>
        {!showOCRScanner ? (
                ...
                <Card className="border-2 border-green-200 bg-green-50/50">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-green-700 mb-3">
                      • <strong>PDF.js + Tesseract.js</strong> : Extraction haute qualité<br/>
