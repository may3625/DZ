...
export function ApprovalWorkflow({ 
  ...
  }, [formData, validateExtractedData]);

  const validateExtractedData = useCallback(() => {
    const errors: string[] = [];
  ...
  }, [formData, extractionMetadata, setCurrentStep, addWorkflowComment]);

  const addWorkflowComment = useCallback((comment: Omit<WorkflowComment, 'id' | 'timestamp'>) => {
