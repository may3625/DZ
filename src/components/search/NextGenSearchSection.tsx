...
export function NextGenSearchSection() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showSemanticModal && (
        <UnifiedModalSystem
          modal={{ id: 'semantic-search', type: 'search' as const, title: 'Recherche Sémantique Avancée', onSearch: () => {} }}
      ...
      {showConceptModal && (
        <UnifiedModalSystem
          modal={{ id: 'concept-analysis', type: 'search' as const, title: 'Analyse Conceptuelle', onSearch: () => {} }}
      ...
      {showImmersiveModal && (
        <UnifiedModalSystem
          modal={{ id: 'immersive-search', type: 'search' as const, title: 'Interface Immersive de Recherche', onSearch: () => {} }}
