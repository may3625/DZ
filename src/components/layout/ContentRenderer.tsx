...
import { LazyOCRProcessor } from "@/components/lazy/LazyOCRProcessor";
...
export function ContentRenderer({ activeSection, language, refreshTrigger }: ContentRendererProps) {
  switch (activeSection) {
    ...
    // OCR + IA sections - Composants fonctionnels
        case "ocr-extraction":
      return (
        <ResponsiveContainer variant="full" spacing="default">
    ...
    case "legal-search":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <LegalTextsSections section={activeSection} language={language} />
        </ResponsiveContainer>
      );
    ...
    case "procedures-resources":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <ProceduresSections section={activeSection} language={language} />
        </ResponsiveContainer>
      );
    ...
    case "reports":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <AnalysisReportsSections section={activeSection} language={language} />
        </ResponsiveContainer>
      );
    ...
    case "ai-assistant":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <EnhancedAILegalAssistant />
        </ResponsiveContainer>
      );
    case "assisted-writing":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <EnhancedAssistedWritingSection />
        </ResponsiveContainer>
      );
    ...
    case "shared-resources":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <CollaborationSections section={activeSection} language={language} />
        </ResponsiveContainer>
      );
    ...
    case "directories":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <NewsReferencesSections section={activeSection} language={language} />
        </ResponsiveContainer>
      );
    ...
    case "translation-management":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <ConfigurationSections section={activeSection} language={language} />
        </ResponsiveContainer>
      );
    case "sources":
    ...
    case "algerian-enhancements":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <AlgerianEnhancementsSection language={language} />
        </ResponsiveContainer>
      );
    case "integrations-interoperability":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <IntegrationsInteroperabilitySection language={language} />
        </ResponsiveContainer>
      );
    ...
    case "accessibility-settings":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <EnhancedAccessibilitySettings language={language} />
        </ResponsiveContainer>
      );
    case "offline-mode":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <OfflineMode language={language} />
        </ResponsiveContainer>
      );
    ...
    case "technical-support":
      return (
        <ResponsiveContainer variant="full" spacing="default">
          <HelpSections section={activeSection} language={language} />
        </ResponsiveContainer>
      );
