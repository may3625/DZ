...
export function FormLibrary({ onSelectTemplate, onAddToLegalTexts, onAddToProcedures }: FormLibraryProps) {
  ...
  // Éviter les doublons en utilisant un Set pour collecter les catégories uniques
  // Exclure les catégories déjà couvertes par les filtres prédéfinis
  const excludedCategories = ['État Civil', 'Urbanisme', 'Commerce', 'Emploi', 'Santé', 'Éducation', 'Transport', 'Fiscalité', 'Textes Juridiques', 'Procédures Administratives'];
  
  const uniqueCategories = Array.from(new Set(ALL_FORM_TEMPLATES.map(t => t.category)))
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <Select value={selectedCategory} onValueChange={setSelectedCategory}>
          ...
          <SelectContent>
            ...
            {uniqueCategories.length > 0 && <div className="border-t my-2" />}
