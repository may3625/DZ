import { Settings, BookOpen, Package, Bell, Users, Zap, Languages } from 'lucide-react';
...
import { TranslationManagement } from "./configuration/TranslationManagement";
...
export function ConfigurationSections({ section, language = "fr" }: ConfigurationSectionsProps) {
  const getSectionTitle = () => {
    const titles = {
      fr: {
        ...
        'translation-management': 'Traduction'
      },
      ar: {
        ...
        'translation-management': 'الترجمة'
      },
      en: {
        'nomenclature': 'Nomenclature',
  ...
  const getSectionDescription = () => {
    const descriptions = {
      fr: {
        ...
        'translation-management': 'Gérez les traductions de l\'interface dans toutes les langues supportées.'
      },
      ar: {
        ...
        'translation-management': 'أدر ترجمات الواجهة في جميع اللغات المدعومة.'
      },
      en: {
        ...
        'translation-management': 'Manage interface translations in all supported languages.'
      }
    };
  ...
  const getSectionIcon = () => {
    switch (section) {
      ...
      case "translation-management":
        return Languages; // Langues pour traduction
      default:
  ...
  const getSectionIconColor = () => {
    switch (section) {
      ...
      case "translation-management":
        return "text-indigo-600"; // Indigo pour traduction
      default:
  ...
  const getSectionContent = () => {
    switch (section) {
      ...
      case "translation-management":
        return <TranslationManagement language={language} />;
      default:
