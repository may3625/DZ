...
export function BreadcrumbNavigation({ currentSection, onSectionChange, language = "fr", onRefresh }: BreadcrumbNavigationProps) {
  ...
  const excludeFromAutoRefresh = [
    ...
    "nomenclature", "complementary-resources", /* removed: "data-management", */ "alerts-notifications", 
  ...
  const getText = (key: string) => {
    const translations = {
      fr: {
        ...
        // removed: "batch-processing": "Traitement par Lot",
        ...
        // removed: "ai-advanced": "IA Avancée",
        ...
        // removed: "advanced-search": "Recherche avancée",
        // removed: "saved-searches": "Recherches sauvegardées",
        // removed: "admin": "Administration",
        "security": "Sécurité",
        ...
        // removed: "data-management": "Gestion des données",
        "alerts-notifications": "Alertes & Notifications",
        "user-management": "Gestion des utilisateurs",
        "about": "À propos",
        "contact": "Contact",
        "technical-support": "Support technique",
        "ocr-diagnostics": "Diagnostics OCR",
      ...
      ar: {
        ...
        // removed: "batch-processing": "المعالجة المجمعة",
        ...
        // removed: "ai-advanced": "الذكاء الاصطناعي المتقدم",
        ...
        // removed: "advanced-search": "البحث المتقدم",
        // removed: "saved-searches": "البحثات المحفوظة",
        // removed: "admin": "الإدارة",
        "security": "الأمان",
        ...
        // removed: "data-management": "إدارة البيانات",
      ...
      en: {
        ...
        // removed: "batch-processing": "Batch Processing",
        ...
        // AI Sections
        "ai-search": "AI Search",
        // removed: "ai-advanced": "Advanced AI",
        ...
        // removed: "advanced-search": "Advanced Search",
        // removed: "saved-searches": "Saved Searches",
        // removed: "admin": "Administration",
        "security": "Security",
        ...
        // removed: "data-management": "Data management",
  ...
  const getParentSection = (section: string) => {
    ...
    if (["ocr-extraction", /* removed: "batch-processing", */ "approval-workflow", "ocr-analytics-reports"].includes(section)) return "ocrIA";
    if (["ai-search", /* removed: "ai-advanced", */ "ai-assistant", "ai-comprehensive-test"].includes(section)) return "ai";
    ...
    if (["nomenclature", "complementary-resources", /* removed: "data-management", */ "alerts-notifications", "user-management", "security", "performance-scalability", "integrations-interoperability", "accessibility-settings", "offline-mode", "mobile-app"].includes(section)) return "configuration";
    if (["about", "contact", "technical-support"].includes(section)) return "help";
    // Ajouts spécifiques
    if (section === "ocr-diagnostics") return "ocrIA";
    if (section === "sources-management") return "admin";
    // Sections autonomes (pas de parent)
    if (["favorites", "data-extraction", "document-templates", /* removed: "advanced-search", */ /* removed: "saved-searches" */].includes(section)) return null;
    return null;
  };
