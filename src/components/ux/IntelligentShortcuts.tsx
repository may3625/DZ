      ...
      <Card>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-end">
                <Button className="w-full" onClick={() => {
                  if (!newShortcutKey.trim() || !newShortcutAction.trim()) {
                    alert('Veuillez renseigner la combinaison et l\'action');
                    return;
                  }
                  alert(`Raccourci ajouté: ${newShortcutKey} → ${newShortcutAction}`);
                  setNewShortcutKey('');
          ...
          <div className="flex gap-4">
            <Button className="bg-yellow-600 hover:bg-yellow-700" onClick={() => alert('Configuration des raccourcis enregistrée') }>
              <Keyboard className="w-4 h-4 mr-2" />
              Enregistrer Configuration
            </Button>
            <Button variant="outline" onClick={() => {
              setAdaptiveShortcuts(true);
              setLearningMode(true);
              setContextualSuggestions(true);
              setNewShortcutKey('');
              setNewShortcutAction('');
              alert('Paramètres IA réinitialisés');
            }}>
