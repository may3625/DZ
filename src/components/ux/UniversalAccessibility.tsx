      ...
      <Card>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button size="sm" className="bg-green-600 hover:bg-green-700" onClick={() => alert('Lecture de test...') }>
                    <Play className="w-4 h-4 mr-1" />
                    Test vocal
                  </Button>
                  <Button size="sm" variant="outline" onClick={() => alert('Ouvrir les paramètres d\'accessibilité...') }>
          ...
          <div className="flex gap-4">
            <Button className="bg-emerald-600 hover:bg-emerald-700" onClick={() => alert('Configuration d\'accessibilité appliquée') }>
