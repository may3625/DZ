...
const ProceduresApprovalQueue: React.FC = () => {
  console.log('🔄 [ProceduresApprovalQueue] Composant en cours de chargement...');
  ...
  useEffect(() => {
    console.log('📋 [ProceduresApprovalQueue] Chargement des documents mock...');
    ...
    console.log('✅ [ProceduresApprovalQueue] Documents chargés:', mockDocuments.length);
  }, []);
  ...
  console.log('🎨 [ProceduresApprovalQueue] Rendu du composant avec', documents.length, 'documents');
