...
import { Plus, FileText, Users, Building, Clock, Star, Filter, SortAsc, Eye, Scale, BookOpen, Heart, Upload, Quote, Search, Download, Share2, Languages } from 'lucide-react';
      ...
      {isMultiLanguageModalOpen && selectedProcedure && (
        <MultiLanguageDocumentModal
          ...
          originalDocument={{
            ...
            content: selectedProcedure.description
          }}
        />
      )}
